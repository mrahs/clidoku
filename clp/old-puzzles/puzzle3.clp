...
(defrule puzzle
	...
	(assert (cell (id 03) (val 6) (box 1) (row 1) (col 3) ))
	...
	(assert (cell (id 10) (val 8) (box 2) (row 1) (col 4) ))
	(assert (cell (id 11) (val 7) (box 2) (row 1) (col 5) ))
	(assert (cell (id 12) (val 0) (box 2) (row 1) (col 6) ))
	(assert (cell (id 13) (val 2) (box 2) (row 2) (col 4) ))
	(assert (cell (id 14) (val 0) (box 2) (row 2) (col 5) ))
	(assert (cell (id 15) (val 3) (box 2) (row 2) (col 6) ))
	(assert (cell (id 16) (val 0) (box 2) (row 3) (col 4) ))
	(assert (cell (id 17) (val 4) (box 2) (row 3) (col 5) ))
	(assert (cell (id 18) (val 0) (box 2) (row 3) (col 6) ))
	(assert (cell (id 19) (val 1) (box 3) (row 1) (col 7) ))
	...
	(assert (cell (id 26) (val 9) (box 3) (row 3) (col 8) ))
	(assert (cell (id 27) (val 0) (box 3) (row 3) (col 9) ))   
	(assert (cell (id 28) (val 5) (box 4) (row 4) (col 1) ))
	(assert (cell (id 29) (val 0) (box 4) (row 4) (col 2) ))
	(assert (cell (id 30) (val 0) (box 4) (row 4) (col 3) ))
	(assert (cell (id 31) (val 3) (box 4) (row 5) (col 1) ))
	(assert (cell (id 32) (val 9) (box 4) (row 5) (col 2) ))
	(assert (cell (id 33) (val 0) (box 4) (row 5) (col 3) ))
	(assert (cell (id 34) (val 0) (box 4) (row 6) (col 1) ))
	(assert (cell (id 35) (val 7) (box 4) (row 6) (col 2) ))
	...
	(assert (cell (id 43) (val 4) (box 5) (row 6) (col 4) ))
	...
	(assert (cell (id 47) (val 6) (box 6) (row 4) (col 8) ))
	...
	(assert (cell (id 54) (val 3) (box 6) (row 6) (col 9) ))   
	(assert (cell (id 55) (val 0) (box 7) (row 7) (col 1) ))
	(assert (cell (id 56) (val 4) (box 7) (row 7) (col 2) ))
	...
	(assert (cell (id 65) (val 1) (box 8) (row 7) (col 5) ))
	(assert (cell (id 66) (val 0) (box 8) (row 7) (col 6) ))
	(assert (cell (id 67) (val 3) (box 8) (row 8) (col 4) ))
	(assert (cell (id 68) (val 0) (box 8) (row 8) (col 5) ))
	(assert (cell (id 69) (val 6) (box 8) (row 8) (col 6) ))
	(assert (cell (id 70) (val 0) (box 8) (row 9) (col 4) ))
	(assert (cell (id 71) (val 2) (box 8) (row 9) (col 5) ))
	(assert (cell (id 72) (val 4) (box 8) (row 9) (col 6) ))
	...
	(assert (cell (id 79) (val 7) (box 9) (row 9) (col 7) ))
