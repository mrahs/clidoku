...
(defrule puzzle
   ...
   (assert (cell (id 02) (val 9) (box 1) (row 1) (col 2) ))
   (assert (cell (id 03) (val 0) (box 1) (row 1) (col 3) ))
   (assert (cell (id 04) (val 6) (box 1) (row 2) (col 1) ))
   ...
   (assert (cell (id 09) (val 8) (box 1) (row 3) (col 3) ))
   (assert (cell (id 10) (val 4) (box 2) (row 1) (col 4) ))
   ...
   (assert (cell (id 18) (val 3) (box 2) (row 3) (col 6) ))
   (assert (cell (id 19) (val 7) (box 3) (row 1) (col 7) ))
   (assert (cell (id 20) (val 0) (box 3) (row 1) (col 8) ))
   (assert (cell (id 21) (val 0) (box 3) (row 1) (col 9) ))
   (assert (cell (id 22) (val 2) (box 3) (row 2) (col 7) ))
   (assert (cell (id 23) (val 0) (box 3) (row 2) (col 8) ))
   (assert (cell (id 24) (val 1) (box 3) (row 2) (col 9) ))
   (assert (cell (id 25) (val 0) (box 3) (row 3) (col 7) ))
   (assert (cell (id 26) (val 4) (box 3) (row 3) (col 8) ))
   ...
   (assert (cell (id 30) (val 5) (box 4) (row 4) (col 3) ))
   ...
   (assert (cell (id 35) (val 8) (box 4) (row 6) (col 2) ))
   ...
   (assert (cell (id 43) (val 9) (box 5) (row 6) (col 4) ))
   ...
   (assert (cell (id 56) (val 7) (box 7) (row 7) (col 2) ))
   (assert (cell (id 57) (val 0) (box 7) (row 7) (col 3) ))
   (assert (cell (id 58) (val 5) (box 7) (row 8) (col 1) ))
   (assert (cell (id 59) (val 0) (box 7) (row 8) (col 2) ))
   (assert (cell (id 60) (val 4) (box 7) (row 8) (col 3) ))
   (assert (cell (id 61) (val 0) (box 7) (row 9) (col 1) ))
   (assert (cell (id 62) (val 0) (box 7) (row 9) (col 2) ))
   (assert (cell (id 63) (val 2) (box 7) (row 9) (col 3) ))
   (assert (cell (id 64) (val 3) (box 8) (row 7) (col 4) ))
   ...
   (assert (cell (id 73) (val 1) (box 9) (row 7) (col 7) ))
   ...
   (assert (cell (id 78) (val 7) (box 9) (row 8) (col 9) ))
   (assert (cell (id 79) (val 0) (box 9) (row 9) (col 7) ))
   (assert (cell (id 80) (val 3) (box 9) (row 9) (col 8) ))
