...
(defrule puzzle
	...
	=>
	(retract ?f)
   (assert (cell (id 01) (val 8) (box 1) (row 1) (col 1) ))
   (assert (cell (id 02) (val 0) (box 1) (row 1) (col 2) ))
   (assert (cell (id 03) (val 0) (box 1) (row 1) (col 3) ))
   (assert (cell (id 04) (val 7) (box 1) (row 2) (col 1) ))
   ...
   (assert (cell (id 11) (val 1) (box 2) (row 1) (col 5) ))
   (assert (cell (id 12) (val 0) (box 2) (row 1) (col 6) ))
   (assert (cell (id 13) (val 0) (box 2) (row 2) (col 4) ))
   (assert (cell (id 14) (val 4) (box 2) (row 2) (col 5) ))
   (assert (cell (id 15) (val 0) (box 2) (row 2) (col 6) ))
   (assert (cell (id 16) (val 5) (box 2) (row 3) (col 4) ))
   ...
   (assert (cell (id 20) (val 5) (box 3) (row 1) (col 8) ))
   (assert (cell (id 21) (val 4) (box 3) (row 1) (col 9) ))
   ...
   (assert (cell (id 33) (val 7) (box 4) (row 5) (col 3) ))
   (assert (cell (id 34) (val 0) (box 4) (row 6) (col 1) ))
   (assert (cell (id 35) (val 5) (box 4) (row 6) (col 2) ))
   ...
   (assert (cell (id 39) (val 1) (box 5) (row 4) (col 6) ))
   ...
   (assert (cell (id 47) (val 9) (box 6) (row 4) (col 8) ))
   (assert (cell (id 48) (val 0) (box 6) (row 4) (col 9) ))
   (assert (cell (id 49) (val 4) (box 6) (row 5) (col 7) ))
   ...
   (assert (cell (id 62) (val 2) (box 7) (row 9) (col 2) ))
   ...
   (assert (cell (id 66) (val 3) (box 8) (row 7) (col 6) ))
   (assert (cell (id 67) (val 0) (box 8) (row 8) (col 4) ))
   (assert (cell (id 68) (val 7) (box 8) (row 8) (col 5) ))
   (assert (cell (id 69) (val 0) (box 8) (row 8) (col 6) ))
   (assert (cell (id 70) (val 0) (box 8) (row 9) (col 4) ))
   (assert (cell (id 71) (val 6) (box 8) (row 9) (col 5) ))
