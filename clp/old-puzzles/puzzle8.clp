...
(defrule puzzle
	...
	=>
	(retract ?f)
   (assert (cell (id 01) (val 2) (box 1) (row 1) (col 1) ))
   (assert (cell (id 02) (val 3) (box 1) (row 1) (col 2) ))
   (assert (cell (id 03) (val 0) (box 1) (row 1) (col 3) ))
   (assert (cell (id 04) (val 4) (box 1) (row 2) (col 1) ))
   ...
   (assert (cell (id 15) (val 9) (box 2) (row 2) (col 6) ))
   ...
   (assert (cell (id 25) (val 1) (box 3) (row 3) (col 7) ))
   ...
   (assert (cell (id 34) (val 8) (box 4) (row 6) (col 1) ))
   (assert (cell (id 35) (val 1) (box 4) (row 6) (col 2) ))
   (assert (cell (id 36) (val 0) (box 4) (row 6) (col 3) ))
   (assert (cell (id 37) (val 2) (box 5) (row 4) (col 4) ))
   ...
   (assert (cell (id 45) (val 3) (box 5) (row 6) (col 6) ))
   (assert (cell (id 46) (val 0) (box 6) (row 4) (col 7) ))
   (assert (cell (id 47) (val 1) (box 6) (row 4) (col 8) ))
   ...
   (assert (cell (id 57) (val 6) (box 7) (row 7) (col 3) ))
   ...
   (assert (cell (id 65) (val 8) (box 8) (row 7) (col 5) ))
   (assert (cell (id 66) (val 0) (box 8) (row 7) (col 6) ))
   (assert (cell (id 67) (val 4) (box 8) (row 8) (col 4) ))
   ...
   (assert (cell (id 80) (val 7) (box 9) (row 9) (col 8) ))
